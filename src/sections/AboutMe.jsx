			...
			<div className="mx-auto max-w-7xl px-6 lg:px-8">
				<div className="mx-auto max-w-2xl lg:mx-0">
					...
					<p className="mt-6 text-lg leading-8 text-dark-blue">
						...
						<br />
						<br />
						In-depth understanding of Database Theory, with practical skills in
						MongoDB, MySQL, along with proficiency in Command Line and Git.
						<br />
						<br />
						...
						<br />
						<br />
						Development of an extensive portfolio, comprising web applications,
						mobile app coding, and various challenging projects, displaying a
						well-rounded skill set.
						<br />
						<br />
						Receipt of a Certificate of Completion from UT Austin, signifying a
						notable accomplishment and enhancing career prospects.
						<br />
						<br />
						...
						interview preparation, portfolio reviews, soft skills training, and
						more, all designed to strategically position for professional
						success.
					</p>
				</div>
